...
bool loadMedia()
{
    ...
    //     if( gFpsTexture.loadFromRenderedText( "The quick brown fox jumps over the lazy dog", textColor ) == false )
    //     {
    ...
    //Load scene images
    if( gSpriteSheetTexture.loadFromFile( "14-animation/foo-sprites.png" ) == false )
    {
