...
bool init()
{
    ...
    else
    {
        ...
        if( SDL_CreateWindowAndRenderer( "SDL3 Tutorial: Motion", kScreenWidth, kScreenHeight, 0, &gWindow, &gRenderer ) == false )
        {
...
bool loadMedia()
{
    ...
    //Load scene textures
    if( gDotTexture.loadFromFile( "13-motion/dot.png" ) == false )
    {
